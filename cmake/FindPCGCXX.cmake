...
add_library(PCGCXX::PCGCXX INTERFACE IMPORTED)
if (USE_SYSTEM_PCGCXX)
    target_include_directories(PCGCXX::PCGCXX INTERFACE "${PCGCXX_INCLUDE_DIR}")
else ()
    target_include_directories(PCGCXX::PCGCXX INTERFACE "pcg-cpp/include")
endif ()
