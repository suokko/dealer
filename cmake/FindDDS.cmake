...
add_library(DDS::DDS INTERFACE IMPORTED)
if (USE_SYSTEM_DDS)
    target_include_directories(DDS::DDS INTERFACE "${DDS_INCLUDE_DIR}")
    #Not used: target_link_libraries(DDS::DDS INTERFACE "${DDS_LIBRARY}")
else ()
    target_include_directories(DDS::DDS INTERFACE "dds/include")
endif ()
